...
const handleWebhook = express.Router();

const endpointSecret = "whsec_3fd88f7b9afe27f8d049c02d692bb7b1637f0f455f626287afb4fdcf7943903a";

// handleWebhook.post('/webhook', express.raw({type: 'application/json'}), (request, response) => {
