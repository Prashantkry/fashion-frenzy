  ...
  return (
    <>
      <div className="bg-black min-h-[100vh]">
        <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16 offer0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            ...
            {products.map((e, i) => (
              <div
                key={i}
                className="rounded overflow-hidden shadow-lg flex flex-col w-[300px] bg-gray-900"
              >
                <Link to="#"></Link>
                ...
                <div className="px-6 py-6 mb-auto">
                  <Link
                    to="#"
                    className="font-medium text-lg hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2 text-gray-100"
                  >
                    {e.ProductName}
                  </Link>
                  <p className="text-gray-500 text-sm overflow-scroll max-h-[7vh] no-scrollbar">
                    {e.ProductDescriptions}
                  </p>
                </div>
                <div className="px-6 py-1 flex flex-row items-center justify-between bg-gray-100">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    >
                      <span className="ml-1 text-lg">
                        ₹{e.ProductPrice - (20 * e.ProductPrice) / 100}
