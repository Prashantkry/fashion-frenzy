...
export default function Contact() {
  return (
    <div className="bg-gray-900 h-[85vh] p-10">
      <div className="flex flex-col lg:flex-row justify-center items-center h-full mx-4">
        {/* info data start */}
        <div className="max-w-[50vw] h-[76vh] rounded-md 2xl:w-3/5 text-gray-300 border-2 border-gray-800 border-dotted p-4 m-4">
          <h1 className="text-3xl lg:text-5xl font-bold w-11/12">
            Get in touch
          </h1>
          <div className="mt-3 lg:mt-4 text-base leading-1 text-gray-400 md:w-8/12 2xl:w-7/12">
            <div>
              <div className="m-2 -ml-0.5 flex border-0 justify-around items-center w-[10vw] text-2xl">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="m-2 ring-2 p-1 rounded-full ring-gray-500 bg-gray-500"
                  height="28"
                  width="28"
                  viewBox="0 0 512 512"
                >
              ...
              <p className="ml-[25%] -mt-4 tracking-wider ">FashionFrenzy@gmail.com</p>
            </div>
        ...
        <div className="lg:w-[50vw] h-[76vh] rounded flex w-full bg-gray-800 flex-col justify-center px-5 py-7 md:px-7 md:py-7 lg:py-12 lg:px-20 mt-2 md:mt-6 lg:mt-0">
          <h2 className="text-2xl tracking-widest font-semibold text-gray-300">
            Send us a message
          </h2>
          <input
          ...
          ></textarea>
          <button className="bg-indigo-700 hover:bg-indigo-600 rounded-md mt-4 md:mt-5 leading-4 p-4 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700">
            Send
          </button>
        </div>
